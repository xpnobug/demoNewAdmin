...
import com.newadmin.demoservice.config.core.ExpressionUtils;
...
import com.newadmin.demoservice.config.security.limiter.autoconfigure.RateLimiterProperties;
import com.newadmin.demoservice.config.security.limiter.enums.LimitType;
import com.newadmin.demoservice.config.security.limiter.exception.RateLimiterException;
...
public class RateLimiterAspect {
     ...
     * 单个限流注解切点
     */
    @Pointcut("@annotation(com.newadmin.demoservice.config.security.limiter.annotation.RateLimiter)")
     ...
     * 多个限流注解切点
     */
    @Pointcut("@annotation(com.newadmin.demoservice.config.security.limiter.annotation.RateLimiters)")
