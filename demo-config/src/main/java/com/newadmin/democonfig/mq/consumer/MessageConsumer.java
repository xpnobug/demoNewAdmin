...
import com.newadmin.democonfig.mq.MessageDto;
...
public class MessageConsumer {
    ...
    /**
     * 监听消息队列，队列名称QUEUE_NAME 通过brokerContainerFactory获取到对应的queue
     */
    ...
    public static <T> T parse(String json, Class<T> clazz) {
        try {
            ...
            try {
                ...
                log.error("InstantiationException or IllegalAccessException, clazz = {}", clazz,
                    e1);
                return null;
            }
        }
