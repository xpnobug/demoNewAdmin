...
import com.newadmin.democonfig.apidoc.handler.BaseEnumParameterHandler;
import com.newadmin.democonfig.apidoc.handler.OpenApiHandler;
...
public class SpringDocAutoConfiguration implements WebMvcConfigurer {
    ...
    public OpenAPI openApi(ProjectProperties projectProperties,
        SpringDocExtensionProperties properties) {
        ...
        if (null != components) {
            ...
            if (MapUtil.isNotEmpty(securitySchemeMap)) {
                ...
                List<String> list = securitySchemeMap.values().stream().map(SecurityScheme::getName)
                    .toList();
