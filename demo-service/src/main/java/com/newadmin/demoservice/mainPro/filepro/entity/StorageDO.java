...
public class StorageDO extends ValueMap {
    ...
    public StorageDO(Map<String, Object> map) {
        super(map);
    }
     ...
     * 设置 Access Key（访问密钥）
     *
     * @param accessKey Access Key（访问密钥）
     */
     ...
     * 设置 Secret Key（私有密钥）
     *
     * @param secretKey Secret Key（私有密钥）
     */
