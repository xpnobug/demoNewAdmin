...
import com.newadmin.demoservice.config.messaging.mail.core.MailConfigurer;
...
public class MailUtils {
    ...
    public static JavaMailSenderImpl getMailSender() {
        ...
        MailConfigurer mailConfigurer = ExceptionUtils.exToNull(
            () -> SpringUtil.getBean(MailConfigurer.class));
