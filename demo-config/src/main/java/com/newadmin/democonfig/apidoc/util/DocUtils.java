package com.newadmin.democonfig.apidoc.util;
...
public class DocUtils {
    ...
    public static String getEnumValueTypeAsString(Class<?> enumClass) {
        ...
        Map<Class<?>, String> typeMap = Map
            .of(Integer.class, "integer", Long.class, "long", Double.class, "number", String.class,
                "string");
        // 遍历所有接口
    ...
    public static Map<Object, String> getDescMap(Class<?> enumClass) {
        ...
        return Arrays.stream(enums)
            .collect(Collectors.toMap(BaseEnum::getValue, BaseEnum::getDescription, (a, b) -> a,
                LinkedHashMap::new));
    }
}