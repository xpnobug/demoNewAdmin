...
@Schema(description = "直播记录信息")
public class LiveResp extends ValueMap {
     ...
     * 用户信息
     */
    public static final String USER_INFO_QUERY = "user";

    public LiveResp() {
    }

    public LiveResp(Map<String, Object> map) {
        super(map);
    }
     ...
     * @param liveRoom
     */
    public void setLiveRoom(LiveRoomDetailResp liveRoom) {
        super.setValue(LIVE_ROOM, liveRoom);
    }
    ...
    public String getLiveRoom() {
        return super.getValueAsString(LIVE_ROOM);
    }
    ...
    public void setUserInfoQuery(UserInfoQuery userInfoQuery) {
        super.setValue(USER_INFO_QUERY, userInfoQuery);
    }
    ...
    public String getUserInfoQuery() {
        return super.getValueAsString(USER_INFO_QUERY);
    }
