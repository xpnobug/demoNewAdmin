package com.newadmin.democonfig.mail.util;
...
import com.newadmin.democonfig.mail.core.MailConfigurer;
...
public class MailUtils {
    ...
    public static JavaMailSenderImpl getMailSender() {
        ...
        MailConfigurer mailConfigurer = ExceptionUtils.exToNull(() -> SpringUtil.getBean(
